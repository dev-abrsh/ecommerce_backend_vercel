...
class CreateOrderDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { user_id: { required: true, type: () => String }, order_items: { required: true, type: () => [String], minItems: 1 }, total_price: { required: true, type: () => Number }, payment_status: { required: false, type: () => String } };
    }
}
